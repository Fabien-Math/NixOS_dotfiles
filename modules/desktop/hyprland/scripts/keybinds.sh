...
yad \
  ...
  "SUPER SHIFT Tab" "Toggle the window on focus to float" "togglesplit"\
  ...
  "SUPER Tab" "Move focus down" "movefocus d" \
  "SUPER Tab" "Switch between desktop applications" "exec launcher window" \
  "SUPER 1-0" "Switch to workspace 1-10" "workspace 1-10" \
  "SUPER 1-0" "Move to workspace 1-10" "movetoworkspace 1-10" \
