        ...
        wayland.windowManager.hyprland = {
          ...
          settings = {
            ...
            exec-once = [
              ...
              # "${getExe monitorswitch}" # Monitor switching
            ...
            windowrule = [
              #"noanim, class:^(Rofi)$
              # "tile,title:(.*)(Godot)(.*)$"
              "workspace 1, class:^(firefox|floorp|zen|zen-beta)$"
              "workspace 2 silent, class:^(parsed_simulator|stonefish_simulator)$"
              "workspace 5 silent, class:^(rqt|io.plotjuggler.PlotJuggler)$"
            ...
            bind = [
              ...
              "$mainMod CTRL SHIFT, K, exec, ${getExe keybinds-inputrc}"
              "$mainMod CTRL, T, exec, ${getExe keybinds-kitty}"
              ...
              # Launch ros2 base attacher script
              "$mainMod, D, exec, $term -e ros2-base-attacher"
            ...
            monitor = [
            	# Laptop screen
		          "desc:Chimei Innolux Corporation 0x1521,1920x1080@60.02,0x360,1.0"
							# Thesis screens
		          "desc:Lenovo Group Limited P24QD-40 VKVK5787,2560x1440@60.0,1920x0,1.0"
		          "desc:Lenovo Group Limited P24q-30 V90EZ1NZ,2560x1440@60.0,4480x0,1.0"
							# Home screens
							"desc:Iiyama North America PL3484WQ 1251650400525, 3440x1440@60.0,auto-center-left,1.0"
            ];
